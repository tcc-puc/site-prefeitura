      ...
      <>
        ...
        <div className="wrapper">
          ...
          <div className="wrapper center">
            <svg xmlns="http://www.w3.org/2000/svg" height="130" viewBox="0 0 320 80" fill="#000000" shapeRendering="crispEdges" version="1.1"><path transform="matrix(0.5072,0,0,48.0000,20,16)" d={info.codigoBarras}/></svg>
        </div>
        </section>
      </>
    )
